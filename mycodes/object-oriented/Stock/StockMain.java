...
public class StockMain {
    public static void main(String[] args) {
        ...
        // first stock
        System.out.print("First stock's sympol: ");
        ...
        Stock stock2 = new Stock(symbol1);
    ...
    public static double makePurchases(Stock currentStock,Scanner console) {
        ...
        int numPerchase = console.nextInt();

        //  ask about each purchase
        for (int i = 1;i <= numPerchase;i++) {
        ...
        // use the Stock to compute profit
